...
<table>
    <thead>
        ...
        <tr>
            <th colspan="7" class="form-header">
                Form - XII<br>
                The Contract Labour (R&A) Act, 1970, (Uttar Pradesh) Rules, 1975, (See Rule 74)<br>
        ...
        <tr>
            ...
            <th rowspan="2">Maximum No. of Workmen <br>Employed by Contractor</th>
        </tr>
        <tr>
            <th>From</th>
            <th>To</th>
    ...
    <tbody>
       <?php if (!empty($stateData)): ?>
        ...
        <?php else: ?>
            <tr>
                <td colspan="7" class="no-data">No contractor data available for Uttar Pradesh <?= $currentState ?></td>
            </tr>
        <?php endif; ?>
        <tr>
