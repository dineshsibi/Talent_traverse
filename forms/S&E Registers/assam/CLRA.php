...
<body>
    <table>
        <thead>
            <tr>
                <th class="form-header" colspan="7">
                    Form - XII <br>
                    The Contract Labour (R&A) Act, 1970, (Assam) Rules, 1971, (See Rule 74) <br>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td class="no-data" colspan="7">No contractor data available for Assam</td>
                </tr>
            <?php endif; ?>
            <tr>
                <th class="signature-date" colspan="3" style="font-weight:bold;">Date</th>
                <th class="signature-auth" colspan="4" style="font-weight:bold;">Authorised Signatory</th>
            </tr>
        </tbody>
    </table>
</body>
