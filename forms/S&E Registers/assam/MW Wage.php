        ...
        <thead>
            <tr>
                <td class="form-header" colspan="10">
                    Form IV-A <br>
                    The Minimum Wages (Central) Rules, 1950 [See Rule 26 ]<br>
                    Register of Wages
                </td>
            </tr>
            <tr>
                <td colspan="5" style="text-align: left;"><b>Name and address of the Establishment </td>
                <td colspan="5" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
            </tr>
            <tr>
                <td colspan="5" style="text-align: left;"><b>Place </td>
                <td colspan="5" style="text-align: left;"><?= htmlspecialchars($location) ?></td>
            </tr>
            <tr>
