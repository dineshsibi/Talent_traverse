...
<body>
     <table>
        <thead>
            <tr>
                <td class="form-header" colspan="40">
                    Form IV <br>
                    The Uttarkhand Minimum Wages Rules, 1952 [Rule 26(5)] <br>
                    Muster Roll 																																			
                </td>
            </tr>    
            <tr>
                <td style="text-align: left;" colspan="6"><b>Name and Address of the Factory/Establishment</td>
                <td colspan="34" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address)?></td>
            </tr>
            <tr>
                <td style="text-align: left;" colspan="6"><b>Place</td>
                <td colspan="34" style="text-align: left;"><?= htmlspecialchars($location_name)?></td>
            </tr>
            <tr>
                <td style="text-align: left;" colspan="6"><b>Month & Year</td>
                <td colspan="34" style="text-align: left;"><?= htmlspecialchars($month . ' - ' . $year)?></td>
            </tr>
            <tr>
        ...
        <?php else: ?>
            <tr>
                <td colspan="38" class="no-data">No data available for Uttarkhand</td>
            </tr>
        <?php endif; ?>
        </tbody>
    </table>
