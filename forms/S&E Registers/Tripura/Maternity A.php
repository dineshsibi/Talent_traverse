        ...
        <table>
            <thead>
                <tr>
                    <td class="form-header" colspan="6">
                        FORM ‘A’ <br>
                        The Maternity Benefit Act, 1961 and The Tripura Maternity Benefit Rules, 1971, [See Rule 3] <br>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="4" style="text-align: left;"><?= $row ? htmlspecialchars($row['employee_name'] . ' , ' . $row['father_name']) : 'Nil' ?></td>
                </tr>
                <tr>
                    <th>3</th>
