...
<table>
    <thead>
        <tr>
            <th colspan="9" class="form-header">
                FORM K <br>
                The Tripura Shops and Establishments Rules, 1970, [See Rule 22] <br>
                Pay Register											
            </th>
        </tr>
        <tr>
    ...
    <?php else: ?>
        <tr>
            <td colspan="9" style="text-align:center;">No employee data found for Tripura</td>
        </tr>
    <?php endif; ?>
        <tr>
            <th colspan="9">This is to certify that I have today in the presence of witness testifying herewith paid the amount of Rs. (<?= number_format($totalNetPay, 2) ?>) in wages to the persons employed by me and that each  employee has received from me the amount due as specified against his name above.</th>
        </tr>
        <tr>
            <th colspan="9" style="text-align:left;">Witness</th>
        </tr>
        <tr>
            <th colspan="9" style="text-align:left;">1.</th>
        </tr>
        <tr>
            <th colspan="9" style="text-align:left;">2.</th>
        </tr>
        <tr>
            <th colspan="9" style="text-align:right;">Signature of shop-keeper/employer</th>
        </tr>
