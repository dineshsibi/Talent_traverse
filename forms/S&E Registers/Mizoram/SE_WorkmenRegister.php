    ...
    <table>
        ...
        <tr>
            <th colspan="16" class="main-heading">
                FORM 'R' <br>
                The Mizoram Shops and Establishments Act, 2010 and Rules, 2011, [See Rule 49 (1)]<br>
        ...
        <tr>
            ...
            <td colspan="8" class="info-data"><?= htmlspecialchars($client_name) ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="8" class="info-data"><?= htmlspecialchars($branch_address) ?></td>
        </tr>
        <tr>
            <td colspan="8" class="info-row">Month & Year</td>
            <td colspan="8" class="info-data"><?= htmlspecialchars($month . ' - ' . $year) ?></td>
        </tr>
        <tr>
            <td colspan="8" class="info-row">Name of the Employer:</td>
            <td colspan="8" class="info-data"><?= htmlspecialchars($employer_name) ?></td>
        </tr>
        ...
        <tr>
         ...
         <?php endforeach; ?>
            ...
            <?php endif; ?>
        <tr>
            <th colspan="16" style="text-align: left;">*According to School records or Birth Register of a Local Authority</th>
        </tr>
    </table>
</body>
</html>