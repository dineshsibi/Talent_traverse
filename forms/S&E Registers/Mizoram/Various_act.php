...
<body>
    <table>
        <thead>
            ...
            <tr>
                <th colspan="25" style="text-align: center;">Rate of Minimum Wages and since the date</th>
            </tr>
            <tr>
                <td colspan="2"></td>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="25" class="no-data">No contractor data available for Mizoram</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
