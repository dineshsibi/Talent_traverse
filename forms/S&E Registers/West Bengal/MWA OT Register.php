    ...
    <table>
        <tr>
            <td colspan="15" class="title">
                FORM IV <br>
                The West Bengal Minimum Wages Rules, 1951, [See Rule 23(4)] <br>
                Over Time Register for Workers
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th style="width: 6%">Normal Rate Pay</th>
        ...
        <?php if (!empty($stateData)): ?>
            ...
            foreach ($stateData as $row): ?>
                ...
                $overtimeEarnings = (float) ($row['over_time_allowance'] ?? 0);
                ...
                <tr>
                    ...
                    <td><?= htmlspecialchars($totalEarnings, 2) ?></td>
        ...
        <?php else: ?>
            <tr>
                <td colspan="15" style="text-align:center;">No data found for West Bengal</td>
            </tr>
        <?php endif; ?>
    </table>
</body>
