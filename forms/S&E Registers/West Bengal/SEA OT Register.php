...
<table>
    <thead>
        <tr>
            <th colspan="5" class="form-header">
                FORM U <br>
                The West Bengal Shops and Establishments Rules, 1964, [See Rule 40] <br>
        ...
        <tr>
            ...
            <td colspan="3" style="text-align: left;"><?= htmlspecialchars($first_row['employer_name'] ?? '') ?></td>
        </tr>
        <tr>
    ...
    <?php else: ?>
        <tr>
            <td colspan="5" style="text-align:center;">No employee data found for West Bengal</td>
        </tr>
    <?php endif; ?>
    </tbody>
</table>
