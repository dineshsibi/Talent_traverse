...
<body>
    <table>
        ...
        <tbody>
            <?php if (!empty($stateData)): ?>
                ...
                foreach ($stateData as $row): ?>
                    <tr>
                        ...
                        <td>
                            <?= htmlspecialchars($row['name_of_contractor'] ?? '') ?>
                        </td>
                        <td>
                            <?= htmlspecialchars($row['nature_of_work_on_contract'] ?? '') ?>
                        </td>
                        <td>
                        ...
                        <td>
                            <?= htmlspecialchars($row['maximum_number_of_workmen_employed_by_contractor'] ?? '') ?>
                        </td>
                    </tr>
            ...
            <?php else: ?>
                <tr>
                    <th colspan="7" style="text-align:center;">No employee data found for Arunachal pradesh</th>
                </tr>
            <?php endif; ?>
