...
<body>
    <table>
        <thead>
            <tr>
                <th class="form-header" colspan="16">
                    FORM-IV <br>
                    The Minimum Wages (Central) Rules, 1950, [See rule 25 (2)] <br>
        ...
        <tbody>
            <?php if (!empty($stateData)): ?>
                ...
                foreach ($stateData as $row): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?= htmlspecialchars($overtime_rate ?? '') ?>
                        </td>
                        <td>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="16" style="text-align:center;">No data available for Arunachal pradesh</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
