...
$currentState = 'Arunachal pradesh'; // Hardcoded for this state template
        ...
        <table>
            <thead>
                <tr>
                    <td class="form-header" colspan="6">
                        FORM A <br>
                        The Maternity Benefit Act, 1961 And (Mines & Circus) Rules, 1963, (See Rule 3) <br>
            ...
            <tbody>
                <tr>
                    ...
                    <td colspan="4" style="text-align: left;">
                        <?= htmlspecialchars($row ? ($row['employee_code'] ?? '') : 'Nil') ?>
                    </td>
                </tr>
                <tr>
                    <th>2</th>
                    ...
                    <td colspan="4" style="text-align: left;">
                        <?= $row ? htmlspecialchars($row['father_name'] ?? '') : 'Nil' ?>
                    </td>
                </tr>
                <tr>
                    <th>3</th>
                    ...
                    <td colspan="4" style="text-align: left;">
                        <?= $row ? htmlspecialchars($row['date_of_joining'] ?? '') : 'Nil' ?>
                    </td>
                </tr>
                <tr>
                    <th>4</th>
                    ...
                    <td colspan="4" style="text-align: left;">
                        <?= $row ? htmlspecialchars($row['designation'] ?? '') : 'Nil' ?>
                    </td>
                </tr>
                <tr>
                    <th>5</th>
                    <th colspan="5" style="text-align: left;">Dates with month and year in which she is employed, laid off
                        or not employed</th>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <?= $row ? htmlspecialchars($row['total_worked_days'] ?? '') : 'Nil' ?>
                    </td>
                    <td>Nil</td>
                    <td>
                        <?= $mlCount > 0 ? $mlCount : 'Nil' ?>
                    </td>
                    <td></td>
                </tr>
                <tr>
                ...
                <tr>
                    <th>12</th>
                    <th style="text-align: left;">Date with amount of maternity benefit paid in advance of expected delivery
                    </th>
                    <td colspan="4" style="text-align: left;">Nil</td>
                </tr>
                <tr>
                ...
                <tr>
                    <th>15</th>
                    <th style="text-align: left;">Date with the amount of wages paid on account of leave under section 9
                    </th>
                    <td colspan="4" style="text-align: left;">Nil</td>
                </tr>
                <tr>
                    <th>16</th>
                    <th style="text-align: left;">Date with the amount of wages paid on account of leave under section 10
                        and period of leave granted</th>
                    <td colspan="4" style="text-align: left;">Nil</td>
                </tr>
                <tr>
                    <th>17</th>
                ...
                <tr>
                    <th>18</th>
                    <th style="text-align: left;">maternity benefit and/or other amount was paid, the amount thereof, and
                        the date of payment</th>
                    <td colspan="4" style="text-align: left;">Nil</td>
                </tr>
                <tr>
                    <th>19</th>
                    <th style="text-align: left;">If the woman dies and the child survives, the name of the person to whom
                        the amount of maternity benefit was paid on behalf of the child and the period for which it was paid
                    </th>
                    <td colspan="4" style="text-align: left;">Nil</td>
                </tr>
                <tr>
                    <th>20</th>
                    <th style="text-align: left;">Signature of the employer of the establishment authenticating the entries
                        in the muster-roll</th>
                    <td colspan="4" style="text-align: left;">Nil</td>
                </tr>
                <tr>
                    <th>21</th>
                ...
                <tr>
                    <th colspan="6" style="text-align: right;">Signature of Employer / Manager / Contractor / Authorised
                        Person</th>
                </tr>
            </tbody>
        </table>
