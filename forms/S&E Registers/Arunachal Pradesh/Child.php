...
<body>
    <table>
        <thead>
            <tr>
                <th class="form-header" colspan="11">
                    Form A <br>
                    The Child Labour (Prohibition and Regulation) Rules, 1988, [See Rule 16 (1)] <br>
            ...
            <tr>
                <th colspan="3" style="text-align: left;">Nature of work done by the Establishment</th>
                <td colspan="8" style="text-align: left;">
                    <?= $nature_of_business ?>
                </td>
            </tr>
            <tr>
                ...
                <th colspan="2" style="text-align: left;">Place of Work </th>
                <td colspan="3" style="text-align: left;">
                    <?= htmlspecialchars(($first_row['location_name'] ?? '')) ?>
                </td>
            </tr>
            <tr>
                <th>Sl. No.</th>
        ...
        <tbody>
            ...
            <tr>
                <th colspan="11" style="text-align: right;"> Signature of Employer / Manager / Contractor / Authorised
                    Person </th>
            </tr>
        </tbody>
    </table>
