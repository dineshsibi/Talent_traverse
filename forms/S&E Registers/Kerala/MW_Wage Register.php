    ...
    <table>
        <tr>
            <td colspan="19" class="header">
                Form XI<br>
                The Kerala Minimum Wages Rules, 1958 [Rule 29 (1)]<br>
                Register of Wages
            </td>
        </tr>
        <tr>
            <td colspan="4" class="subheader" style="text-align: left;">Name of establishment & Address :</td>
            <td colspan="15" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
        </tr>
        <tr>
            <td colspan="4" class="subheader" style="text-align: left;">Wages period :</td>
            <td colspan="15" style="text-align: left;"><?= htmlspecialchars($month . ' - ' . $year) ?></td>
        </tr>
        <tr>
            <td colspan="4" class="subheader" style="text-align: left;">Place</td>
