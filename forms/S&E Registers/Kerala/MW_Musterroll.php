...
<body>
     <table>
        <thead>
            <tr>
                <td class="form-header" colspan="39">
                    Form VI <br>
                    The Kerala Minimum Wages Rules, 1958 [Rule 29 (5) ] <br>
                    Muster Roll 																																			

                </td>
            </tr>    
            <tr>
                <td style="text-align: left;" colspan="7"><b>Name and Address of the Factory/Establishment</td>
                <td colspan="32" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address)?></td>
            </tr>
            <tr>
                <td style="text-align: left;" colspan="7"><b>Place</td>
                <td colspan="32" style="text-align: left;"><?= htmlspecialchars($location_name)?></td>
            </tr>
            <tr>
                <td style="text-align: left;" colspan="7"><b>Month & Year</td>
                <td colspan="32" style="text-align: left;"><?= htmlspecialchars($month . ' - ' . $year)?></td>
            </tr>
            <tr>
                <th rowspan="2">Sl. No</th>
                <th rowspan="2">Sl . No of the Employee</th>
        ...
        <?php else: ?>
            <tr>
                <td colspan="39" class="no-data">No data available for Kerala</td>
            </tr>
        <?php endif; ?>
        </tbody>
    </table>
