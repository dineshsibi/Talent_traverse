...
<table>
    ...
    <tr>
        <td colspan="38" class="form-header-cell">
            FORM V <br>
            The Sikkim Minimum Wages Rules, 2005,  [Rule 26(5)] <br>
            Muster Roll 
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="26" style="text-align: left;"><?= htmlspecialchars($first_row['location_name'] ?? '') ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <th colspan="31">For the Period Ending - <?= htmlspecialchars($month . ' - ' . $year) ?></th>
    ...
    <?php else: ?>
        <tr>
            <td colspan="38" style="text-align:center;">No employee data found for Sikkim</td>
        </tr>
    <?php endif; ?>
        <tr>
