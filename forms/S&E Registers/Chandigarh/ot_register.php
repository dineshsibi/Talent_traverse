...
<body>
    <table>
        ...
        <?php if (!empty($stateData)): ?>
            <?php $i = 1; foreach ($stateData as $row): ?>
                <?php
                    ...
                    $overtimeRate = (($normalRate / 31) / 8) * 2;; // Assuming overtime is double the normal rate
                ...
                <tr>
                    ...
                    <td><?= number_format(round($overtimeRate)) ?></td>
        ...
        <?php else: ?>
            <tr>
                <td colspan="16" style="text-align:center;">No data found for Chandigarh</td>
            </tr>
        <?php endif; ?>
    </table>
</body>
