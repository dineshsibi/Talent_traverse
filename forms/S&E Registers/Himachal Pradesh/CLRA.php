...
<table>
    <thead>
        ...
        <tr>
            <th colspan="7" class="form-header">
                Form XII<br>
                The Contract Labour (R&A) Act, 1970 (Himachal Pradesh) Rules, 1974, (See Rule 74) <br>
    ...
    <tbody>
       <?php if (!empty($stateData)): ?>
        ...
        <?php else: ?>
            <tr>
                <th colspan="7" class="no-data">No contractor data available for Himachal Pradesh</th>
            </tr>
        <?php endif; ?>
        <tr>
