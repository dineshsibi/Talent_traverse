...
<body>
    <table>
        <thead>
            <tr>
                <th class="title" colspan="16">
                    Form VIII<br>
                    The Goa, Daman and Diu Minimum Wages Rules, 1975, [Rule 28(2)]<br>
                    Overtime register for worker
                </th>
            </tr>
            <tr>
            ...
            <tr>
                <th colspan="8" style="text-align:left">Wage Period</th>
            ...
            <tr>
                ...
                <th>Total over-time worked or production in case of place-worker</th>
                <th>Normal hours</th>
                <th>Normal rates</th>
                <th>Overtime rate</th>
       ...
       <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="16" style="text-align:center;">No employee data found for Goa</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
