...
<body>
     <table>
        <thead>
            <tr>
                <td class="form-header" colspan="40">
                    Form V <br>
            ...
            <tr>
                <td style="text-align: left;" colspan="8"><b>Name and Address of the Factory/Establishment</td>
                <td colspan="32" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address)?></td>
            </tr>
            <tr>
                <td style="text-align: left;" colspan="8"><b>Place</td>
                <td colspan="32" style="text-align: left;"><?= htmlspecialchars($location_name)?></td>
            </tr>
            <tr>
                <td style="text-align: left;" colspan="8"><b>Month & Year</td>
        ...
        <?php else: ?>
            <tr>
                <td colspan="7" class="no-data">No data available for Andhra Pradesh</td>
            </tr>
        <?php endif; ?>
        </tbody>
    </table>
