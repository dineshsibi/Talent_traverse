...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>1</td>
            <td>Total realisation under fines</td>
            <td>Nil</td><td>Nil</td><td>Nil</td><td>Nil</td>
        </tr>
        <tr>
            <td>2</td>
            <td>Total amount becoming unpaid accumulation of</td>
            <td>Nil</td><td>Nil</td><td>Nil</td><td>Nil</td>
        </tr>
        <tr>
            <td>3 (I)</td>
            <td class="indent">Basic wages</td>
            <td>Nil</td><td>Nil</td><td>Nil</td><td>Nil</td>
        </tr>
        <tr>
            <td>(II)</td>
            <td class="indent">Overtime</td>
            <td>Nil</td><td>Nil</td><td>Nil</td><td>Nil</td>
        </tr>
        <tr>
            <td>(III)</td>
            <td class="indent">Dearness allowance and other allowance</td>
            <td>Nil</td><td>Nil</td><td>Nil</td><td>Nil</td>
        </tr>
        <tr>
            <td colspan="2" class="label-cell">Total of (1)(2)</td>
            <td>Nil</td><td>Nil</td><td>Nil</td><td>Nil</td>
        </tr>
    </tbody>
</table>
