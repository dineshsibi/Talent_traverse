...
<body>
    <table>
        <thead>
            <tr>
                <th class="form-header" colspan="26">
                    Form B <br>
                    Format For Wage Register <br>
                    The Ease Of Compliance To Maintain Registers Under Various Labour Laws Rules, 2017 [See Rule 2 (1)]
                </th>
            </tr>
            <tr>
                <th colspan="11" style="text-align: left;">Name and Address of The Factory Establishment </th>
                <td colspan="15" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
            </tr>
            <tr>
                <th colspan="11" style="text-align: left;">Name of Owner </th>
                <td colspan="15" style="text-align: left;"><?= htmlspecialchars($employer_name) ?></td>
            </tr>
            <tr>
                <th colspan="11" class="label" style="text-align: left;">LIN </th>
                <td colspan="15" style="text-align: left;">-</td>
            </tr>
            <tr>
                <th colspan="11" class="label" style="text-align: left;">Wage period </th>
                <td colspan="15" style="text-align: left;"><?= htmlspecialchars($month . ' - ' . $year) ?></td>
            </tr>
            <tr>
                <th colspan="11" style="text-align: left;">(Monthly/Fortnightly/Weekly/Daily/Piece Rated)</th>
                <td colspan="15" style="text-align: left;">Monthly</td>
            </tr>
            <tr>
                <th colspan="26" style="text-align: left;">Rate of Minimum Wages and since the date</th>
            </tr>
            <tr>
                <td colspan="2"></td>
                <th colspan="5" class="skill-categories">Highly Skilled</th>
                <th colspan="5" class="skill-categories">Skilled</th>
                <th colspan="7" class="skill-categories">Semi-Skilled</th>
                <th colspan="7" class="skill-categories">Un Skilled</th>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="25" class="no-data">No contractor data available for Andhra Pradesh</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
