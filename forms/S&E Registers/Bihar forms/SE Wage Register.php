...
<body>
    <table>
        <thead>
            <tr>
                <td class="form-header" colspan="13">
                    Form X <br>
                    The Bihar Shops and Establishments Rules, 1955, [Rule 17]<br>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="left-align"><?= $datesString ?: 'No overtime' ?></td>
        ...
        <?php else: ?>
            <tr>
                <td colspan="7" class="no-data">No contractor data available for Bihar</td>
            </tr>
        <?php endif; ?>
        </tbody>
    </table>
