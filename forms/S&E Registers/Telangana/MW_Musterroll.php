...
<body>
    <table>
        <thead>
            <tr>
                <td class="form-header" colspan="42">
                    Form No V <br>
                    The Andhra Pradesh Minimum Wages Rules, 1960 [Rule 30(5)] <br>
                    Muster Roll
                </td>
            </tr>
            <tr>
                <td style="text-align: left;" colspan="9"><b>Name and Address of the Factory/Establishment</td>
                <td colspan="33" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
            </tr>
            <tr>
                <td style="text-align: left;" colspan="9"><b>District</td>
                <td colspan="33" style="text-align: left;"><?= htmlspecialchars($location_name) ?></td>
            </tr>
            <tr>
                <td style="text-align: left;" colspan="9"><b>Month & Year</td>
                <td colspan="33" style="text-align: left;"><?= htmlspecialchars($month . ' - ' . $year) ?></td>
            </tr>
            <tr>
                ...
                <th rowspan="2">Designation/Nature of<br>Work</th>
                <th rowspan="2">Group</th>
                <th rowspan="2">Relay</th>
                <th rowspan="2">Shift No</th>
                <th rowspan="2">Period of Work</th>
                <th colspan="31" style="text-align: center;">For the Period Ending</th>
                <th rowspan="2">Total no of actual working days</th>
            ...
            <tr>
                ...
                <th>7</th>
                <th>8</th>
                <th colspan="31" style="text-align: center;">9</th>
                <th>10</th>
                <th>11</th>
            </tr>
        </thead>
