...
<head>
    ...
    <style>
        * {
        ...
        body {
            font-size: 12px;
            margin: 10px;font-family: 'Times New Roman', Times, serif;
        }
        table {
            width: 100%;
    ...
    table-layout: fixed;font-family: 'Times New Roman', Times, serif;
        ...
        th, td {
            ...
            vertical-align: top;font-family: 'Times New Roman', Times, serif;
        }
        th {
    ...
    <tbody>
        ...
        <tr>
            <td colspan="19" class="form-title">
                FORM D <br>
                A.P. Labour Welfare Fund Act, 1987 & Rules, 1988 [See sub-rule(1) of Rule 4] <br>
                Register Of Wages																	
            </td>
        </tr>
        ...
        <!-- Establishment Info -->
        <tr>
            <td colspan="3" style="font-weight:bold; text-align: left;">Name and Address of the Factory/ Establishment</td>
            <td colspan="16" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
        </tr>
        <tr>
            <td colspan="3" style="font-weight:bold; text-align: left;">Month & Year</td>
        ...
        <?php if (!empty($stateData)): ?>
            <?php $i = 1; foreach ($stateData as $row): ?>
                <?php
                   ...
                   $bk=(float) ($row['net_pay'] ?? 0);
                    $dearness=$bk-($basic + $ot + $bonus);
                ?>
                <tr>
                    <td><?= $i++ ?></td>
                ...
                <td><?= htmlspecialchars($row['designation'] ?? '') ?></td>
                    ...
                    <td><?= number_format($basic, 2) ?></td>
                    <td><?= number_format($ot, 2) ?></td>
                    <td><?= number_format($dearness, 2) ?></td>
                    <td><?= number_format($bonus, 2) ?></td>
                    <td>Nil</td>
                    <td>Nil</td>
                    <td>Nil</td>
        ...
        <?php else: ?>
            <tr>
                <td colspan="19" style="text-align:center;">No data available for Talangana</td>
            </tr>
        <?php endif; ?>
        <tr>
            <th colspan="19" style="text-align: right;"> <br><br>Signature of Employer or Officer making</th>
        </tr>
    </tbody>
</table>
