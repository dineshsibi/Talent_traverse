        ...
        <thead>
            <tr>
                <th class="form-header" colspan="12">
                    Form I<br>
                    The Delhi Minimum Wages Rules, 1950, 1953 [Rule(21(4)]<br>
                    Register of Fines
                </th>
            </tr>
            <tr>
                <td colspan="6" style="text-align: left;"><b>Name and Address of the Factory/ Establishment </td>
                <td colspan="6" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . ($first_row['branch_address'] ?? '')) ?></td>
            </tr>
            <tr>
                <td colspan="6" style="text-align: left;"><b>Employer </td>
                <td colspan="6" style="text-align: left;"><?= htmlspecialchars($first_row['employer_name'] ?? ' - ') ?></td>
            </tr>
            <tr>
                <td colspan="6" style="text-align: left;"><b>For the Month of </td>
