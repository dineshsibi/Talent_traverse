...
<body>
    <table>
        <thead>
            <tr>
                <th class="form-header" colspan="7">
                    FORM - XII<br>
                    The Contract Labour (R&A) Act, 1970 ( Delhi ) Rules, 1972 (See Rule 74)<br>
        ...
        <?php else: ?>
            <tr>
                <td class="no-data" colspan="7">No contractor data available for Delhi</td>
            </tr>
            <tr>
                <th style="text-align: left;" colspan="3">Date</th>
