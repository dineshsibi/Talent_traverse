        ...
        <thead>
            <tr>
                <th class="form-header" colspan="7">
                    Form - XII<br>
                    The Contract Labour (R&A) Act, 1970 (Madhya Pradesh) Rules, 1973 (See Rule 74)<br>
        ...
        <tbody>
            <?php if (!empty($stateData)): ?>
                <?php $i = 1; foreach ($stateData as $row): ?>
                    ...
                    <?php else: ?>
                <tr>
                    <td class="no-data" colspan="7">No contractor data found for Madhya Pradesh</td>
                </tr>
                <?php endif; ?>
                    <tr>
                        <th class="signature-date" colspan="3"><b>Date</th>
                        <th class="signature-auth" colspan="4"><b>Authorised Signatory</th>
                    </tr>
             </tbody>
    </table>
</body>
