        ...
        <table>
            <tr>
                <th colspan="22" class="title">
                    Form N<br>
                    The Chattisgarh Shops And Establishment Act, 1958 and Rules, 1959 [See Rules 20 (1) and 21 (2)]<br>
            ...
            <tr>
                ...
                <td><?= !empty($row['date_of_leaving']) ? htmlspecialchars($row['date_of_leaving']) : '-' ?></td>
