...
<body>
     <table>
        <thead>
            <tr>
                <th class="form-header" colspan="38">
                    FORM V<br>
                    The Bihar Minimum Wages Rules, 1951 [Rule 26(5)]<br>
                    Muster Roll 
                </th>
            </tr>    
            <tr>
                <th style="text-align: left;" colspan="16">Name and Address of the Establishment</th>
                <td colspan="22" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address)?></td>
            </tr>
            <tr>
                <th style="text-align: left;" colspan="16">Place</th>
                <td colspan="22" style="text-align: left;"><?= htmlspecialchars($location_name)?></td>
            </tr>
            <tr>
                <th style="text-align: left;" colspan="16">Month & Year</th>
        ...
        <?php else: ?>
            <tr>
                <th colspan="38" style="text-align:center;">No employee data found for Jharkhand</th>
            </tr>
        <?php endif; ?>
        </tbody>
    </table>
