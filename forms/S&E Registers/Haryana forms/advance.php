    ...
    <table>
        <thead>
            ...
            <th class="form-header" colspan="11">
                Form II - A<br>
                The Punjab Minimum Wages Rules, 1950 <br>
            ...
            <tr>
                ...
                <td colspan="5" style="text-align: left;"><?= $client_name ?><?= $branch_address ? ' , ' . $branch_address : '' ?></td>
            </tr>
            <tr>
                <th colspan="6" style="text-align: left;">Month & Year </th>
                <td colspan="5" style="text-align: left;"><?= $month ?><?= $year ? ' - ' . $year : '' ?></td>
            </tr>
            <tr>
                <th>Sr. No</th>
                <th>Employee Code</th>
                ...
                <th>Dates and amount of instalments repaid Date and Amount</th>
                <th>Remarks</th>
            </tr>
             </tr>
                <th>1</th>
