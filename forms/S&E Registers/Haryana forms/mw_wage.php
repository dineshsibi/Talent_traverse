...
<body>
    <table>
        <thead>
            <tr>
                <th class="form-header" colspan="9">
                    Form X<br>
                    The Punjab Minimum Wages Rules, 1950 [See Rule 26 (1)] <br>
                    Register of Wages
                </th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="5" style="text-align: left;"><?= htmlspecialchars($first_row['location_name'] ?? '') ?></td>
            </tr>
            <tr>
                <th colspan="4" style="text-align: left;">Month</th>
            ...
            <tr>
                ...
                <th>Minimum rates of wage payable</th>
        ...
        <?php else: ?>
            <tr>
                    <td class="no-data" colspan="9">No contractor data available for Haryana</td>
                </tr>
        <?php endif; ?>
        </tbody>
    </table>
