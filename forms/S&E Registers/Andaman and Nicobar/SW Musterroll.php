...
<body>
     <table>
        <thead>
            <tr>
                <td class="form-header" colspan="38">
                    FORM III <br>
                    The Andaman and Nicobar Islands Shops and Establishments Rules, 2005, [Rule 11(3)] <br>
                    Muster Roll 																																			
                </td>
            </tr>    
            <tr>
        ...
        <?php else: ?>
            <tr>
                <td colspan="38" class="no-data">No data available for Andaman and Nicobar</td>
            </tr>
        <?php endif; ?>
        </tbody>
    </table>
