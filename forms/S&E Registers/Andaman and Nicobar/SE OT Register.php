...
<body>
    <table>
        <thead>
            <tr>
                <th class="form-header" colspan="16">
                    FORM IV <br>
                    The Andaman and Nicobar Islands Shops and Establishments Rules, 2005, [Rule 11(4)] <br>
            ...
            <tr>
                <th colspan="8" style="text-align: left;">Place</th>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="16" style="text-align:center;">No data available for Andaman and Nicobar</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
