...
<body>
    <table>
        <thead>
            <tr>
                <th class="form-header" colspan="10">
                    Form 1<br>
                    The Tamilnadu Industrial Establishments (Conferment of Permanent Status to Workmen) Rules, 1981 [See sub-Rule (1) under Rule 6]<br>
                    Register of Workmen
                </th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <th>Date on which<br>he completed 480<br>days of Service</th>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td class="no-data" colspan="10">No data available for Tamilnadu</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
