...
<body>
    <table>
        <thead>
            <tr>
                <th class="header" colspan="16">
                    FORM IV <br>
                    The Minimum Wages (Central) Rules, 1950 [Rule 25 (2)] <br>
                    Register of Overtime Workers
                </th>
            </tr>
            <tr>
                <th colspan="9" style="text-align:left">Name and Address of the Establishment /Factory </th>
                <td colspan="7" style='text-align:left'><?= htmlspecialchars($client_name . ' , ' . ($first_row['branch_address'] ?? '')) ?></td>
            </tr>
            <tr>
                <th colspan="9" style="text-align:left">Month Ending</th>
            ...
            <tr>
                ...
                <th>Total overtime worked of production</th>
                <th>Normal Hours</th>
                <th>Normal rate</th>
                <th>Overtime rate</th>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="16" style="text-align:center;">No employee data found for Rajastan</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
