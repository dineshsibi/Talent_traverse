...
<body>
    <table>
        <thead>
            <tr>
                <th class="form-header" colspan="25">
                Form B <br>
            ...
            <tr>
                <th colspan="10" style="text-align: left;">Name and Address of The Factory Establishment </th>
                <td colspan="15" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
            </tr>
            <tr>
                <th colspan="10" style="text-align: left;">Name of Owner </th>
                <td colspan="15" style="text-align: left;"><?= htmlspecialchars($employer_name ) ?></td>
            </tr>
            <tr>
                <th colspan="10" class="label" style="text-align: left;">LIN </th>
                <td colspan="15" style="text-align: left;">-</td>
            </tr>
            <tr>
                <th colspan="10" class="label" style="text-align: left;">Wage period </th>
                <td colspan="15" style="text-align: left;"><?= htmlspecialchars($month . ' - ' . $year) ?></td>
            </tr>
            <tr>
                <th colspan="10" style="text-align: left;">(Monthly/Fortnightly/Weekly/Daily/Piece Rated)</th>
                <td colspan="15" style="text-align: left;">Monthly</td>
            </tr>
            <tr>
                <th colspan="10" style="text-align: left;">Rate of Minimum Wages and since the date</th>
                <td colspan="15"></td>              
            </tr>
            <tr>
                <td colspan="2"></td>
                ...
                <th colspan="6" class="skill-categories">Un Skilled</th>
            </tr>
            <tr>
