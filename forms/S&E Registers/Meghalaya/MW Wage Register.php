    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?= htmlspecialchars($row['total_deduction'] ?? '') ?>
                </td>
                <td>
                    <?= htmlspecialchars($row['net_pay'] ?? '') ?>
                </td>
                <td></td>
            </tr>
            <?php endforeach; ?>
            <?php else: ?>
            <tr>
                <td colspan="10" class="no-data">No data available for Meghalaya</td>
            </tr>
            <?php endif; ?>
        </tbody>
    </table>
