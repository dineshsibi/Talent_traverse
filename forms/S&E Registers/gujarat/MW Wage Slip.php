...
try {
    ...
    $employee_name = safe($first_row['employee_name'] ?? '');
    $father_name = safe($first_row['father_name'] ?? '');
...
<head>
    <style>
        ...
        .wage-slip-container {
            ...
            height: 100vh; /* Ensure each form takes full page */
        }
        .wage-slip-container:last-child {
            page-break-after: auto; /* No break after last form */
        }
    </style>
</head>
<body>
    ...
    ?>
        ...
        <tr>
            <td colspan="5" class="header">
                FORM VI-B <br>
                The Gujarat Minimum Wages Rules, 1961 [See rule 26(2)] <br>
                WAGES SLIPS 
            </td>        
        </tr>
        <tr>
            <td class="subheader" colspan="2" style="text-align: left;">Name of the Establishment:</td>
            <td colspan="3" style="text-align: left;"><?= htmlspecialchars($client_name . ' , '. ($first_row['branch_address'] ?? '')) ?></td>
        </tr>
        <tr>
            <td class="subheader" colspan="2" style="text-align: left;">Place:</td>
        ...
        <tr>
            ...
            <td colspan="3" style="text-align: left;"><?= htmlspecialchars($employee_name . ' , ' . $father_name) ?></td>
        </tr>
        <tr>
            <td class="bold">2</td>
        ...
        <tr>
            <th colspan="5" style="text-align: right;">Pay-in charge</th>
        </tr>
        <tr>
            <th colspan="5" style="text-align: right;">Employee's Signature Thumb Impression</th>
        </tr>
        </table>
    <?php endforeach; ?>
</body>
