...
<body>
    <table>
        <thead>
            <tr>
                <th class="form-header" colspan="39">
                    Form V<br>
                    The Gujarat Minimum Wages Rules, 1961 [Rule 26(5)]<br>
                    Muster Roll
                </th>
            </tr>
            <tr>
                <th colspan="19" class="align">Name and Address of the Establishment</th>
                <td colspan="20" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . ($first_row['branch_address'] ?? '')) ?></td>
            </tr>
            <tr>
                <th colspan="19" class="align">Place</th>
                <td colspan="20" style="text-align: left;"><?= $location ?></td>
            </tr>
            <tr>
                <th colspan="19" class="align">For the Period ending </th>
        ...
        <?php else: ?>
            <tr>
                <th colspan="19" style="text-align:center;">No data available for Gujarat</th>
            </tr>
        <?php endif; ?>
        </tbody>
    </table>
