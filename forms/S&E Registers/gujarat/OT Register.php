...
<body>
    <table>
        <thead>
            <tr>
                <th class="header" colspan="16">
                    Form IV<br>
                    The Gujarat Minimum Wages Rules, 1961 [Rule 25 (2)]<br>
                    Overtime Register for Workers
                </th>
            </tr>
            <tr>
                <th colspan="8" class="align">Name and Address of the Establishment /Factory </th>
                <td colspan="8"  style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . ($first_row['branch_address'] ?? '')) ?></td>
            </tr>
            <tr>
                <th colspan="8" class="align">Month & Year </th>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="19" style="text-align:center;">No employee data found for Gujarat</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
