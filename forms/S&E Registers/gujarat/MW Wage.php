        ...
        <thead>
            <tr>
                <th class="form-header" colspan="10">
                    Form IV-A <br>
                    The Gujarat Minimum Wages Rules, 1961, [See Rule 26 (1)]<br>
                    Register of Wages
                </th>
            </tr>
            <tr>
                <th colspan="5" class="align">Name and address of the Establishment </th>
                <td colspan="5" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
            </tr>
            <tr>
                <th colspan="5" class="align">Place </th>
