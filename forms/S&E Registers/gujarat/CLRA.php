...
<table>
    <thead>
        ...
        <tr>
            <th colspan="7" class="form-header">
                FORM - XII<br />
                The Contract Labour (R&A) Act, 1970, (Gujarat) Rules, 1972 {See Rule 74}<br />
        ...
        <tr>
            <th colspan="3" class="bold">Name and Address of the Principal Employer</th>
            <td colspan="4" style="text-align: left;">
               <?= htmlspecialchars($employer_name . ' , ' . $employer_address) ?>
            </td>
        </tr>
        <tr>
            <th colspan="3" class="bold">Name and address of establishment</th>
            <td colspan="4" style="text-align: left;">
                <?= $client_name ?><?= $branch_address ? ' , ' . $branch_address : '' ?>
            </td>
        </tr>
        <tr>
            <th colspan="3" class="bold">For the Month Of</th>
            <td colspan="4" style="text-align: left;">
                <?= $month ?><?= $year ? ' - ' . $year : '' ?>
            </td>
        </tr>
    ...
    <tbody>
       <?php if (!empty($stateData)): ?>
        ...
        <?php else: ?>
            <tr>
                <th colspan="7" class="no-data">No contractor data available for Gujarat</th>
            </tr>
        <?php endif; ?>
    </tbody>
</table>
