        ...
        <thead>
            <tr>
                <th class="form-header" colspan="12">
                    FORM II<br>
                    The Gujarat Minimum Wages Rules, 1961, [Rule 21 (4)]<br>
                    Register of deductions for damage or loss caused to the employer, by the neglect or default of the employed persons<br>
                    Employer
                </th>
            </tr>
            <tr>
                <th colspan="6" class="align">Name and Address of the Factory/ Establishment </th>
                <td colspan="6" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address ?? '') ?></td>
            </tr>
            <tr>
                <th colspan="6" class="align">Month & Year </th>
