...
<body>
     <table>
        <thead>
            ...
            <tr>
                <th colspan="3" class="bold">Name and address of Employer</th>
                <td  colspan="8" style="text-align: left;"><?= htmlspecialchars($employer_name . ' , ' . $employer_address) ?></td>
            </tr>
            <tr>
                <th colspan="3" class="bold">Nature of work done by the Establishment</th>
                <td  colspan="8" style="text-align: left;"><?= $nature_of_business ?></td>
            </tr>
            <tr>
                <th colspan="3" class="bold">Month & Year</th> 
