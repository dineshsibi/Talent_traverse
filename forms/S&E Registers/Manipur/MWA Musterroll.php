...
<body>
    ...
    <table>
        ...
        <tr>
            <td colspan="41" class="form-header-cell">
                FORM V <br>
        ...
        <tr>
            ...
            <td colspan="29" style="text-align: left;"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th>8</th>
            <th>9</th>
            <th colspan="31" style="text-align:center;">10</th>
            <th>11</th>
        </tr>
        ...
        <?php if (!empty($stateData)): ?>
            ...
            foreach ($stateData as $row): ?>
                <tr>
                    ...
                    <td><?= htmlspecialchars($row['designation'] ?? '') ?> / <?= htmlspecialchars($row['nature_of_business'] ?? '') ?></td>
        ...
        <?php else: ?>
            <tr>
                <td colspan="41" style="text-align:center;">No employee data found for Manipur</td>
            </tr>
        <?php endif; ?>
        <tr>
            <th colspan="41" style="text-align: right;">Signature of Employer</th>
        </tr>
    </table>
