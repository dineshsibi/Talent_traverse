...
$currentState = $_SESSION['current_state'] ?? 'West Bengal';
    ...
    ?>
        <div class="employee-form" style="<?= $isLast ? '' : 'page-break-after: always;' ?>">
            <table>
                ...
                <tr>
                    <th rowspan="3">7</th>
                    <th colspan="4" style="text-align: left;">Dates with month and year in which she is employed, laid off and not re-employed</th>
                </tr>
                <tr>
                    <th>Month</th>
