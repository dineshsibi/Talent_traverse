...
<body>
    <table>
        <thead>
            <tr>
                <td class="form-title" colspan="36">FORM XVI<br>
                                    (See Rule 78(2) (a))<br>
                                    Muster Roll
                </td>
            </tr>
            <tr>
                ...
                <td colspan="21" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
            </tr>
            <tr>
                <th colspan="15" style="text-align: left;">Nature and location of work </th>
                <td colspan="21" style="text-align: left;"><?= htmlspecialchars($location_code . ' , ' . $nature_of_business) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="21" style="text-align: left;"><?= htmlspecialchars($principal_employer . ' , ' . $principal_employer_address) ?></td>
            <tr>
            <tr>
                <th colspan="15" style="text-align: left;">For the month of </th>
                <td colspan="21" style="text-align: left;"><?= htmlspecialchars($month . ' - ' . $year) ?></td>
            </tr>
            <tr>
                <th rowspan="2">SL No</th>
                <th rowspan="2">Name of Workman</th>
                <th rowspan="2">Father's/ Husband Name</th>
                <th rowspan="2">Sex</th>
                <th colspan="31" style="text-align: center;">Days of Month</th>
