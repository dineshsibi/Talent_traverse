...
<body>
    ...
    ?>
        <div class="employee-form" style="<?= $isLast ? '' : 'page-break-after: always;' ?>">
            <table>
                <tr>
                    <td class="form-title" colspan="3">FORM XIV <br>
                        [See rule 72 (2) (a)] <br>
                        Employment Card
                    </td>
                </tr>
                ...
                <tr>
                    <th>3</th>
                    <th style="text-align: left;">Nature of Employment / Designation</th>
                ...
                <tr>
                    <th>5</th>
                    <th style="text-align: left;">Wage Rate (with particulars of unit, in case of piece work)</th>
                ...
                <tr>
                    <th>7</th>
                    <th style="text-align: left;">Tenure of Employment</th>
