     ...
     <table>
        <thead>
            ...
            <tr>
                ...
                <td colspan="17" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
            </tr>
            <tr>
                <th colspan="11" style="text-align: left;">Nature and location of work </th>
                <td colspan="17" style="text-align: left;"><?= htmlspecialchars($location_code . ' , ' . $nature_of_business) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="17" style="text-align: left;"><?= htmlspecialchars($principal_employer . ' , ' . $principal_employer_address) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="17" style="text-align: left;"><?= htmlspecialchars($month . ' - ' . $year) ?></td>
            </tr>
            <tr>
                <th colspan="28" style="text-align: left;">Rate of Minimum Wages and since the date: APRIL-2025</th>
            </tr>
            <tr>
                <td colspan="4"></td>
