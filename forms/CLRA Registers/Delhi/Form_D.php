...
<body>
    <table>
        <thead>
            ...
            <tr>
                <th colspan="15">Name and address of Contractor </th>
                <td colspan="26"><?= htmlspecialchars($client_name . ' & ' .$address)?></td>
            </tr>
            <tr>
                <th colspan="15">Nature and location of work </th>
                <td colspan="26"><?= htmlspecialchars($nature . ' & ' .$currentLocation)?></td>
            </tr>
            <tr>
                <th colspan="15">Name and address of establishment in/under which contract is carried on </th>
                <td colspan="26"><?= htmlspecialchars($client_name . ' & ' .$address)?></td>
            </tr>
            <tr>
                <th colspan="15">Name and address of Principal Employer </th>
                <td colspan="26"><?= htmlspecialchars($principal_employer . ' & ' .$principal_employer_address)?></td>
            </tr>
            <tr>
                <th colspan="15">LIN</th>
                <td colspan="26">-</td>
            </tr>
            <tr>
                <th colspan="15">For the Year</th>
                <td colspan="26"><?= htmlspecialchars($month . ' - ' .$year)?></td>
            </tr>
            <tr>
