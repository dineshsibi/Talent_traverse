     ...
     <table>
        <thead>
            ...
            <tr>
                ...
                <td colspan="17
                "><?= htmlspecialchars($location_code . ' , ' . $nature_of_business) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="17
                "><?= htmlspecialchars($principal_employer . ' , ' . $principal_employer_address) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="17
                "><?= htmlspecialchars($month . ' - ' . $year) ?></td>
            </tr>
            <tr>
                <th style="text-align: center;" colspan="28">Rate of Minimum Wages and since the date: APRIL-2025</th>
            </tr>
            <tr>
                <td colspan="4"></td>
