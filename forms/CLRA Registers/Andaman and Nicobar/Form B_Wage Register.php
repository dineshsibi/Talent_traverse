...
$currentState = $_SESSION['current_state'] ?? 'Andaman and Nicobar';
...
<body>
    <table>
        <thead>
            <tr>
                <th class="form-title" colspan="28">
                    FORM B <br>
                    FORMAT FOR WAGE REGISTER
                </th>
            </tr>
            <tr>
                <th colspan="11" style="text-align: left;">Name and address of Contractor </th>
                <td colspan="17
                " style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
            </tr>
            <tr>
                <th colspan="11" style="text-align: left;">Nature and location of work </th>
                <td colspan="17
                " style="text-align: left;"><?= htmlspecialchars($location_code . ' , ' . $nature_of_business) ?></td>
            </tr>
            <tr>
                <th colspan="11" style="text-align: left;">Name and address of establishment in/under which contract is carried on </th>
                <td colspan="17
                " style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
            </tr>
            <tr>
                <th colspan="11" style="text-align: left;">Name and address of Principal Employer </th>
                <td colspan="17
                " style="text-align: left;"><?= htmlspecialchars($principal_employer . ' , ' . $principal_employer_address) ?></td>
            </tr>
            <tr>
                <th colspan="11" style="text-align: left;">LIN</th>
                <td colspan="17
                ">-</td>
            </tr>
            <tr>
                <th colspan="11" style="text-align: left;">Wage period</th>
                <td colspan="17
                " style="text-align: left;"><?= htmlspecialchars($month . ' - ' . $year) ?></td>
            </tr>
            <tr>
                <th style="text-align: left;" colspan="28">Rate of Minimum Wages and since the date: APRIL-2025</th>
            </tr>
            <tr>
                <td colspan="4"></td>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="19" style="text-align:center;">No data available for Andaman and Nicobar</td>
                </tr>
            <?php endif; ?>
            <tr>
                <th colspan="5">Date </th>
                <td colspan="7"></td>
                <th colspan="16" style="text-align: right;">Authorised Signatory</th>
            </tr>
        </tbody>
    </table>
</body>
