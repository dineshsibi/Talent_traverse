    ...
    ?>
        <div class="employee-form" style="<?= $isLast ? '' : 'page-break-after: always;' ?>">
            <table>
                ...
                <tr>
                    <th>1</th>
                    <th style="text-align: left;">Name and Address of the Establishment</th>
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($client_name . ' & ' . $address) ?></td>
                </tr>
                <tr>
                    <th>2</th>
                ...
                <tr>
                    ...
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['date_of_joining'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>6</th>
                    <th style="text-align: left;">Nature of work</th>
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($nature) ?></td>
                </tr>
                <tr>
                    <th rowspan="3">7</th>
                ...
                <tr>
                    ...
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['notice_date_section6'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>9</th>
                    <th style="text-align: left;">Date of discharge/dismissal, if any</th>
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['discharge_dismissal_date'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>10</th>
                    <th style="text-align: left;">Date of production of proof of pregnancy under Section 6</th>
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['pregnancy_proof_date_section6'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>11</th>
                    <th style="text-align: left;">Date of birth of child</th>
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['child_birth_date'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>12</th>
                    <th style="text-align: left;">Date of production of proof of delivery/miscarriage/Medical Termination of pregnancy/ tubectomy operation/ death</th>
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['delivery_proof_details'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>13</th>
                    <th style="text-align: left;">Date of production of proof of illness referred to in Section 10</th>
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['illness_proof_date_section10'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>14</th>
                    <th style="text-align: left;">Date with the amount of maternity benefit paid in advance of expected delivery</th>
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['advance_maternity_benefit_details'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>15</th>
                    <th style="text-align: left;">Date with the amount of subsequent payment of maternity benefit</th>
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['subsequent_maternity_benefit_details'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>16</th>
                    <th style="text-align: left;">Date with the amount of bonus, if paid under Section 8</th>
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['bonus_payment_details_section8'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>17</th>
                    <th style="text-align: left;">Date with the amount of wages paid on account of leave under Section 9</th>
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['leave_wages_details_section9'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>18</th>
                    ...
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['leave_wages_details_section10'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>19</th>
                    <th style="text-align: left;">Name of the person nominated by the woman under Section 6</th>
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['nominated_person_name'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>20</th>
                    ...
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['death_details'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>21</th>
                    ...
                    <td colspan="3" style="text-align: left;"><?= htmlspecialchars($row['child_survival_details'] ?? '') ?></td>
                </tr>
                <tr>
                    <th>22</th>
