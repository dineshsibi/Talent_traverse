        ...
        <div class="employee-form <?= $isLast ? '' : 'page-break' ?>">
            <table>
                ...
                <tr>
                    ...
                    <td colspan="2" style="text-align: left;"><?= htmlspecialchars($location_code . ' , ' . $nature_of_business) ?></td>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: left;">Name and address of establishment</th>
                    <td colspan="2" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: left;">Name and address of Principal Employer</th>
                    <td colspan="2" style="text-align: left;"><?= htmlspecialchars($principal_employer . ' , ' . $principal_employer_address) ?></td>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: left;">Name and Father's/Husband's name of the workman</th>
                    <td colspan="2" style="text-align: left;"><?= htmlspecialchars(($row['employee_name'] ?? '') . ' , ' . ($row['father_name'] ?? '')) ?></td>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: left;">For the Month ending</th>
                    <td colspan="2" style="text-align: left;"><?= htmlspecialchars($month . ' - ' . $year) ?></td>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: left;">1. No. of days worked</th>
                    <td colspan="2" style="text-align: left;"><?= htmlspecialchars($row['paid_days'] ?? '') ?></td>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: left;">2. No. of units worked (piece-rate)</th>
                    <td colspan="2" style="text-align: left;">Nil</td>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: left;">3. Rate of daily wages/piece-rate</th>
                    <td colspan="2" style="text-align: left;"><?= htmlspecialchars($row['rate_of_wage'] ?? '') ?> / 31</td>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: left;">4. Amount of overtime wages</th>
                    <td colspan="2" style="text-align: left;"><?= htmlspecialchars($row['overtime_rate_of_wages'] ?? '') ?></td>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: left;">5. Gross wages payable</th>
                    <td colspan="2" style="text-align: left;"><?= htmlspecialchars($row['earned_gross'] ?? '') ?></td>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: left;">6. Deductions, if any</th>
                    <td colspan="2" style="text-align: left;"><?= htmlspecialchars($row['total_deductions'] ?? '') ?></td>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: left;">7. Net amount of wages paid</th>
