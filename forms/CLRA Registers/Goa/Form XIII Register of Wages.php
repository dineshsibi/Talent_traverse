  ...
  <table>
    <thead>
      ...
      <tr>
        ...
        <td colspan="12" style="text-align: left;"><?= htmlspecialchars($location_code . ' , ' . $nature_of_business) ?></td>
      </tr>
      <tr>
        <th colspan="8" style="text-align: left;">Name and Address of Principal Employer</th>
        <td colspan="12" style="text-align: left;"><?= htmlspecialchars($principal_employer . ' , ' . $principal_employer_address) ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <th rowspan="2">Sl. No. on the Register of workmen employed by contractor</th>
        ...
        <th rowspan="2">Time and date of Payment</th>
    ...
    <tbody>
      ...
      <?php else: ?>
        <tr>
          <td colspan="20" style="text-align:center;">No data available for Goa</td>
        </tr>
      <?php endif; ?>
      <tr>
