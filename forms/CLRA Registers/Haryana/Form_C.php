...
<body>
    <table>
        <thead>
            ...
            <tr>
                <th colspan="4">Name and address of Contractor </th>
                <td colspan="10"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
            </tr>
            <tr>
                <th colspan="4">Nature and location of work </th>
                <td colspan="10"><?= htmlspecialchars($location_code . ' , ' . $nature_of_business) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="10"><?= htmlspecialchars($principal_employer . ' , ' . $principal_employer_address) ?></td>
            </tr>
            <tr>
                <th colspan="4">LIN</th>
                <td colspan="10">-</td>
            ...
            <tr>
                <th colspan="4">For the Month Year</th>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="14" style="text-align:center;">No data available for Haryana</td>
                </tr>
            <?php endif; ?>
            <tr>
