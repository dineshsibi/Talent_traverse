    ...
    <table>
        <thead>
            ...
            <tr>
                ...
                <td colspan="16"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
            </tr>
            <tr>
                <th colspan="15">Nature and location of work</th>
                <td colspan="16"><?= htmlspecialchars($location_code . ' , ' . $nature_of_business) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="16"><?= htmlspecialchars($principal_employer . ' , ' . $principal_employer_address) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="16"><?= htmlspecialchars($month . ' - ' . $year) ?></td>
            </tr>
            <tr>
                <th>Sl No</th>
                <th>Employee Code</th>
