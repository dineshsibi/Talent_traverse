...
<body>
    <table>
        <thead>
            <tr>
            <td class="form-title" colspan="13">FORM XX<br>
                (See Rule 78(2)(d))<br>
            ...
            <tr>
                ...
                <td colspan="7" style="text-align: left;"><?= htmlspecialchars($location_code . ' , ' . $nature_of_business) ?></td> 
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="7" style="text-align: left;"><?= htmlspecialchars($principal_employer . ' , ' . $principal_employer_address) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <th>Date of recovery First instalment</th>
                <th>Date of recovery Last Instalment</th>
                <th>Remarks</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td><?= htmlspecialchars($row['name_of_person_in_whose_presence_employees_explanation_for_fine'] ?? '') ?></td>
