...
<body>
    <table>
        <thead>
            <tr>
            <td class="form-title" colspan="11">FORM XXII<br>
                            [See rule 78(2)(d)]<br>
                            Register of Advances
            </td>
            </tr>
            <tr>
                <th colspan="5" style="text-align: left;">Name and address of Contractor</th> 
                <td colspan="6" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
            </tr>
            <tr>
                <th colspan="5" style="text-align: left;">Nature and location of work</th>
                <td colspan="6" style="text-align: left;"><?= htmlspecialchars($location_code . ' , ' . $nature_of_business) ?></td>
            </tr>
            <tr>
                <th colspan="5" style="text-align: left;">Name and address of establishment in/under which contract is carried on</th>
                <td colspan="6" style="text-align: left;"><?= htmlspecialchars($client_name . ' , ' . $branch_address) ?></td>
            </tr>
            <tr>
                <th colspan="5" style="text-align: left;">Name and address of Principal Employer</th> 
            ...
            <tr>
                ...
                <th>No. of instalments by which advance to be repaid</th>
                <th>Date and amount of each instalment repaid</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= htmlspecialchars($row['date_and_amount_of_advance_given'] ?? '') ?></td>
                <td><?= htmlspecialchars($row['purposes_for_which_advance_made'] ?? '') ?></td>
                <td><?= htmlspecialchars($row['no_of_installments_by_which_advance_to_be_repaid'] ?? '') ?></td>
                <td><?= htmlspecialchars($row['date_and_amount_of_each_installment_repaid'] ?? '') ?></td>
